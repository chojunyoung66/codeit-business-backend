...
describe("게시글 저장소 테스트 (Mock)", () => {
  ...
  describe("createArticle", () => {
    ...
    test("생성된 게시글의 createdAt과 updatedAt이 설정된다", async () => {
      ...
      expect((article as any).updatedAt).toBeDefined();
      ...
      expect((article as any).updatedAt.getTime()).toBeGreaterThanOrEqual(
        beforeCreate.getTime(),
      );
      expect((article as any).updatedAt.getTime()).toBeLessThanOrEqual(
        afterCreate.getTime(),
      );
    });
  ...
  describe("updateArticle", () => {
    ...
    test("updatedAt이 수정 시점으로 갱신된다", async () => {
      ...
      expect((updated as any).updatedAt.getTime()).toBeGreaterThanOrEqual(
        beforeUpdate.getTime(),
      );
      expect((updated as any).updatedAt.getTime()).toBeLessThanOrEqual(
        afterUpdate.getTime(),
      );
    });
